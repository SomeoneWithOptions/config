...
QtObject {
    ...
    // Nook radius at the four desktop corners, matching Hyprland
    // decoration:rounding so the frame curves like the windows inside it.
    // Set to 0 to drop the corner decorations.
    readonly property int screenCornerRadius: 18
